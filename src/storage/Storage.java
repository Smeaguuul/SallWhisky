...
public class Storage {
    ...
    public static void addTapningsVæske(TapningsVæske tapningsVæske) {
        tapningsVæsker.add(tapningsVæske);
    }

    public static void removeTapningsVæske(TapningsVæske tapningsVæske) {
        tapningsVæsker.remove(tapningsVæske);
    }
